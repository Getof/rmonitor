...
import ru.ecom42.rmonitor.common.events.DisconnectedEvent;
import ru.ecom42.rmonitor.common.events.LoginEvent;
import ru.ecom42.rmonitor.common.events.LoginResultEvent;
import ru.ecom42.rmonitor.common.events.ProfileInfoChangedEvent;
...
//                    .on("finishedTaxi", args -> eventBus.post(new ServiceFinishedEvent((Integer) args[0], (Boolean) args[1], Float.parseFloat(args[2].toString()))))
                    .on("riderInfoChanged", args -> {
                        ...
                        SP.putString("user", args[0].toString());
                        CommonUtils.user = Techdir.fromJson(args[0].toString());
...
//                    });
    ...
    private class LoginRequest extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... uri) {
            try {
                URL url = new URL(getString(R.string.server_address) + "user_login");
